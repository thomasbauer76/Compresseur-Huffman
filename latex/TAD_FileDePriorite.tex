...
\begin{tad}
  ...
  \begin{tadOperations}{obtenirElement}
    ...
    \tadOperationAvecPreconditions{obtenirElementEtDefiler}{FileDePriorite}{\tadParams{Element, FileDePriorite}}
  ...
  \parbox{\linewidth}{\raggedright
      \begin{tadAxiomes}
          ...
          \tadAxiome{obtenirElementEtDefiler(enfiler(fileDePriorite(),e)) = e,fileDePriorite()}
          \tadAxiome{e \leq obtenirElementEtDefiler(f)[1] \Rightarrow obtenirElementEtDefiler(enfiler(f,e)) = e,f}
          \tadAxiome{e > obtenirElementEtDefiler(f)[1] \Rightarrow obtenirElementEtDefiler(enfiler(f,e)) = obtenirElementEtDefiler(f)[1],enfiler(obtenirElementEtDefiler(f)[2],e)}
      \end{tadAxiomes}
  }
...
\begin{algorithme}
    ...
    \signatureProcedure{obtenirElementEtDefiler}{\paramSortie{e : \textbf{Element}}, \paramEntreeSortie{file : \textbf{FileDePriorite}}}{non(estVide(file))}
\end{algorithme}
...
\bigbreak
\begin{algorithme}
    \procedure{obtenirElementEtDefiler}{\paramSortie{e : \textbf{Element}}, \paramEntreeSortie{file : \textbf{FileDePriorite}}}{non(estVide(file))}
    {temp : \textbf{FileDePriorite}}
    {
