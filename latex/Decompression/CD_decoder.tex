\begin{algorithme}
\procedure{decoder}{\paramEntree{aHuff: \arbredehuffman, longueur : \naturel}, \paramEntreeSortie{fb1 : \fichierbinaire, fb2 : \fichierbinaire}}{estOuvert(fb1) et (mode(fb1) $=$ lecture) et estOuvert(fb2) et (mode(fb2) $=$ écriture)}{aTemp : \arbredehuffman, finDecodage : \booleen, OctetCourant, octetDecodé : \octet, bit : \bit, compteurOctetsDecodes : \naturel}
{
