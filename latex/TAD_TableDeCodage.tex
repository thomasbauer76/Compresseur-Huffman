...
\begin{tad}
    ...
    \begin{tadOperations}{octetVersCodeBinaire}
        ...
        \tadOperation{codeBinairePresent}{\textbf{TableDeCodage},\textbf{CodeBinaire}}{\textbf{\booleen}}
        \tadOperation{octetPresent}{\textbf{TableDeCodage},\textbf{Octet}}{\textbf{\booleen}}
    \end{tadOperations}
