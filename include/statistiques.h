...
/**
 * \fn void S_incrementerOccurence(Statistiques *p_s, Octet o)
...
/**
 * \fn void S_fixerOccurence(Statistiques *p_s, Octet o, unsigned long n)
...
/**
 * \fn unsigned long S_obtenirOccurence(Statistiques s, Octet o)
