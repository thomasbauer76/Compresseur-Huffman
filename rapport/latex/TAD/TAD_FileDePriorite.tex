\begin{tad}
  ...
  \begin{tadOperations}{obtenirElementEtDefiler}
    ...
    \tadOperation{enfiler}{\tadParams{\filedepriorite, \textbf{Element}}}{\filedepriorite}
    \tadOperationAvecPreconditions{obtenirElementEtDefiler}{\filedepriorite}{\tadParams{\filedepriorite, \textbf{Element}}}
